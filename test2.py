...
flexmom_high_cr_adjusted = fit_models(adjusted_data, params.methodType)

# Print coefficients of the FlexMom_high_Dl model
print("Coefficients of FlexMom_high_Dl adjusted model:", flexmom_high_cr_adjusted.params.tolist())
